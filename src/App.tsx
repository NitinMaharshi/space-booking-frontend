...
const SpaceDetailsPage = lazy(() =>
  import('@/pages/space-details-page').then((m) => ({ default: m.SpaceDetailsPage })),
);
const DashboardPage = lazy(() =>
  import('@/pages/member/dashboard-page').then((m) => ({ default: m.DashboardPage })),
);
const MyBookingsPage = lazy(() =>
  import('@/pages/member/my-bookings-page').then((m) => ({ default: m.MyBookingsPage })),
);
const ProfilePage = lazy(() =>
  import('@/pages/member/profile-page').then((m) => ({ default: m.ProfilePage })),
);
const AdminDashboardPage = lazy(() =>
  import('@/pages/admin/admin-dashboard-page').then((m) => ({ default: m.AdminDashboardPage })),
);
const ManageSpacesPage = lazy(() =>
  import('@/pages/admin/manage-spaces-page').then((m) => ({ default: m.ManageSpacesPage })),
);
const ManageBookingsPage = lazy(() =>
  import('@/pages/admin/manage-bookings-page').then((m) => ({ default: m.ManageBookingsPage })),
);
const MaintenancePage = lazy(() =>
  import('@/pages/admin/maintenance-page').then((m) => ({ default: m.MaintenancePage })),
);
